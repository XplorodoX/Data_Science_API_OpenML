...
class OpenML_API:
    ...
    def filter_datasets_by_attribute_types(self, attribute_types, limit=None):
...
# Filtern von Datensätzen, die entweder numerische oder nominale Attribute enthalten (begrenzt auf 10)
dataset_names, not_matching = api.filter_datasets_by_attribute_types(['numeric'], limit=400)
print(dataset_names)
print(f"Anzahl der zurückgegebenen Datensätze: {len(dataset_names)}")
print(f"Anzahl der Datensätze, die nicht den Typen 'numeric' oder 'nominal' entsprechen: {not_matching}")