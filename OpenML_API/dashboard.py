...
def format_number(value):
    ...
    if isinstance(value, int) or (isinstance(value, float) and value.is_integer()):
        ...
        return formatted_value.rstrip('0').rstrip(
            '.')  # Entfernt nachfolgende Nullen und den Dezimalpunkt, falls keine Nachkommastellen vorhanden sind
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.P(f"Upload date: {dataset_info.get('upload_date', 'Not available')}"),
                  ...
                  'padding-top': '17px'}),  # Margin links und Padding oben hinzugefügt
